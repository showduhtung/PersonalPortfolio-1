  ...
  render() {
    return (
      <section className="projects">
        ...
        <div className="single-project box2">
          ...
          <div className="rightColumn">
            <img src="../client/assets/vrPacmanScreenshot.jpg" width="80%"/>
          </div>
        </div>

        <div className="single-project box1">
          <div className="leftColumn">
            <h4>TubeNotes</h4>
          ...
          <div className="rightColumn">
            <img src="../client/assets/tubenotesScreenshot1.png" width="80%"/>
          </div>
        </div>
      </section>)
  }
