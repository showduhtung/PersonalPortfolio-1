...
var svg = d3.select("svg"),
        ...
        g = svg.append("g").attr("transform", "translate(30,40)");       // move right 20px.

// x-scale and x-axis
var experienceName = ["", "Basic 1.0","Intermediate 2.0","Advanced 3.0","Expert 4.0"];
...
var tree = d3.cluster()                 // This D3 API method setup the Dendrogram datum position.
        .size([height - 35, width - 460])    // Total width - bar chart width = Dendrogram chart width
